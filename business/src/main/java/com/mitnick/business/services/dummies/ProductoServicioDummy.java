...
public class ProductoServicioDummy extends ServicioBase implements
	...
	public List<TipoDto> obtenerTipos() {
		...
		tipo.setId(1l);
		tipo.setDescripcion("Descripci�n tipo 1");
		
		tipos.add(tipo);
		
		tipo = new TipoDto();
		tipo.setId(1l);
		tipo.setDescripcion("Descripci�n tipo 2");
	...
	public List<MarcaDto> obtenerMarcas() {
		...
		marca.setId(1l);
		marca.setDescripcion("Descripci�n marca 1");
		
		marcas.add(marca);
		
		marca = new MarcaDto();
		marca.setId(1l);
		marca.setDescripcion("Descripci�n marca 2");
