...
public class VentaController extends BaseController {
	...
	public void modificarCantidad(ProductoVentaDto producto, String cantidad) {
		logger.debug("Entrado al m�todo modificarCantidad, con producto: " + producto + " y cantidad: " + cantidad);
		...
		logger.debug("Saliendo del m�todo modificarCantidad");
	}

	public void modificarPrecioUnitario(ProductoVentaDto producto, String precioUnitario) {
		logger.debug("Entrado al m�todo modificarPrecioUnitario, con producto: " + producto + " y precioUnitario: "
				+ precioUnitario);
		...
		logger.debug("Saliendo del m�todo modificarPrecioUnitario");
	}

	public List<ClienteDto> obtenerClientesByFilter(ConsultaClienteDto filtroDto) {
		logger.debug("Entrando al m�todo consultarClienteByFilter con :" + filtroDto);
	...
	public void quitarCliente() {
		logger.debug("Entrando al m�todo quitarCliente");
		...
		logger.info("El cliente se quit� correctamente de la venta.");
		logger.debug("Saliendo del m�todo quitarCliente");
	}

	public BigDecimal agregarCliente() {
		logger.debug("Entrando al m�todo agregarCliente");
		...
		try {
			...
			if (index > -1) {
				index = getVentaClientePanel().getTable().convertRowIndexToModel(index);
				cliente = getVentaClientePanel().getModel().getCliente(index);	
				logger.info("El cliente : " + cliente + " se agreg� correctamente a la venta.");
		...
		try {
			...
			logger.debug("Saliendo del m�todo agregarCliente");
	...
	public BigDecimal getSaldoDeudor() {
		logger.debug("Entrando al m�todo getSaldoDeudor");
	...
	public void validarCliente() {
		logger.debug("Entrando al m�todo validarCliente");
		...
		logger.debug("Saliendo del m�todo validarCliente");
	}
	...
	public void desagregarCliente() {
		logger.debug("Entrando al m�todo desagregarCliente");
		...
		logger.debug("Saliendo del m�todo desagregarCliente");
	}
