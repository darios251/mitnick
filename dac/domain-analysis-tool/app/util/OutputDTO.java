...
public class OutputDTO implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((refDomainsEdu == null) ? 0 : refDomainsEdu.hashCode());
		result = prime * result + ((refDomainsGov == null) ? 0 : refDomainsGov.hashCode());
		result = prime * result + ((refDomianHome == null) ? 0 : refDomianHome.hashCode());
		result = prime * result + ((refDomians == null) ? 0 : refDomians.hashCode());
		result = prime * result + ((refIps == null) ? 0 : refIps.hashCode());
		result = prime * result + ((refSubNet == null) ? 0 : refSubNet.hashCode());
