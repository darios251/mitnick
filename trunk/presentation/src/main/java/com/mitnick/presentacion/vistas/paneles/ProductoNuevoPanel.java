...
//		btnAceptar.setToolTipText(PropertiesManager.getProperty("productoNuevoPanel.tooltip.cancelar"));
	...
	protected void agregarProducto() {
		try {
			productoController.guardarProducto(producto, txtCodigo.getText(), txtDescripcion.getText(), (TipoDto)cmbTipo.getSelectedItem(), (MarcaDto)cmbMarca.getSelectedItem(), txtStock.getText(), txtPrecio.getText());
			limpiarCamposPantalla();
			productoController.mostrarProductosPanel();
		}
